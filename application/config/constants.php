...
defined('PROJECT_NAME')        OR define('PROJECT_NAME','Satyakam'); 
...
if(isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST']=='localhost'){
	...
	defined('DB_HOST')      ? null : define('DB_HOST', 'localhost');
	defined('DB_USER')      ? null : define('DB_USER', 'brightwm_satyakam');
	defined('DB_PASSWORD')  ? null : define('DB_PASSWORD', 'Satyakam@123#');
	defined('DB_NAME')      ? null : define('DB_NAME', 'brightwm_satyakam');
...
defined('API_KEY')       OR define('API_KEY',"rzp_live_gg1NHaPdUA5bdd");
defined('API_SECRET')       OR define('API_SECRET',"hgXwAGH612x4DPxgPWIvE4Y8");