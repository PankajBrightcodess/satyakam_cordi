                   ...
                   <div class="card-header">
                    ...
                    <div class="row">
                        	<div class="col-md-6 col-lg-5">
                                <?php echo form_open_multipart('admin/savesubmenu');?>
                                ...
                                <div class="form-group row">
                                     <div class="col-sm-12">
                                        <?php echo form_input(array('type'=>'text','name'=>'submenu','id'=>'activate_menu','class'=>'form-control','placeholder'=>'Enter Sub Menu','required'=>'true'));?>
                                    </div>  
...
<script>
	...
	$(document).ready(function(e) {
		...
		$('body').on('change','#menu',function(){
			...
			$.ajax({
				type:"POST",
				url:"<?php echo base_url("admin/get_submenu_byid"); ?>",
