                            	...
                            	<table class="table data-table stripe hover nowrap table-bordered">
                                    <thead>
                                        <tr>    
                                            ...
                                            <th>A/C Father's/Husband Name</th> 
                                            <th>Member Id</th>               
                                            <th>Member Name</th>               
                                            <th>Contact No.</th>
                                            <th>Address</th>
                                    ...
                                    <tbody>
                                        <?php $i=0;
                                         if(!empty($accdetails)){
                                            ...
                                            foreach($accdetails as $val){$i++;  ?>
                                        <tr>
                                            
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $val['account_no']; ?></td>
                                            <td><?php echo $val['account_holder_name']; ?></td>
                                            <td><?php echo $val['father_husband_name']; ?></td>
                                            <td><?php echo $val['member_id']; ?></td>
                                            <td><?php echo $val['username']; ?></td>
                                            <td><?php echo $val['mobile_no']; ?></td>
                                            <td><?php echo $val['village'].', '.$val['panchayat'].', '.$val['ward_no'].', '.$val['police_station'].', '.$val['subdivision'].', '.$val['district'].', '.$val['pin_code']; ?></td>
                                            <td><?php echo $val['saving_plan_name']; ?></td>
                                            <td><?php echo $val['team_year'] ;?></td>
                                            <td><?php echo $val['group_name'] ;?></td>
                                            <td ><?php echo $val['meeting_no'] ;?></td>
                                            <td > <a href="<?= base_url('admin/transcationdetails/?accno='.$val['account_no']);?>" class="btn btn-success btn-xs" title="Account Details" ><i class="fa fa-balance-scale" aria-hidden="true"></i></a></td>
