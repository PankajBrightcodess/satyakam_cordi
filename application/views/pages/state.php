                   ...
                   <div class="card-header">
                    ...
                    <div class="row">
                        	<div class="col-md-5 col-lg-4">
                                <?php echo form_open_multipart('admin/savestate');?>
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <?php echo form_input(array('type'=>'text','name'=>'state','id'=>'activate_menu','class'=>'form-control','placeholder'=>'Enter State','required'=>'true'));?>
                                    </div>                                    
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4">
                                        <?php echo form_submit(array('name'=>'save_state','id'=>'save_dep','value'=>'Save Menu','class'=>'form-control btn btn-success'));?>
                                    </div>
                                    <div class="col-md-4"></div>                                    
                                </div>
                                <?php echo form_close();?>
                        	...
                        	<div class="col-md-5 col-lg-6 table-responsive">
                            	<table class="table data-table stripe hover nowrap table-bordered">
                                    ...
                                    <tbody>
                                        <?php $i=0;
                                         if(!empty($state)){
                                            foreach($state as $val){$i++; $id=$val['id']; ?>
                                        <tr>
                                            <td ><?php echo $i ?></td>
                                            ...
                                            <button class="btn btn-danger btn-xs delete" value="<?php echo $val['id'];?>"><i class="fa fa-trash"></i></button>   <!-- <?php echo base_url("home/delete_sidebar/");?> -->
                                             <button type="button" class="btn btn-success btn-xs updt" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $val['id'];?>" data-state="<?php echo $val['state'];?>"><i class="fa fa-edit"></i></button>
                                           </td>
                                        </tr>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
           ...
           <?php echo form_open_multipart('admin/update_state');?>
          <div class="modal-body">
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="form-group row">
                        <div class="col-sm-12 col-md-12">
                            <?php echo form_input(array('type'=>'text','name'=>'state','id'=>'state','class'=>'form-control state','placeholder'=>'Enter Department','required'=>'true'));?>
...
$('.delete').click(function(e){
    ...
    $.ajax({
            type:'GET',
            url:"<?PHP echo base_url('admin/delete_state'); ?>",
            data: {id:id},
