                            	...
                            	<table class="table data-table stripe hover nowrap table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if(!empty($val['sponsor_id'])){ echo $val['sponsor_id']; }else{ echo '#01';} ; ?></td>
                                            <td><?php if(!empty($val['applicant_name'])){ echo $val['applicant_name']; }else{ echo 'Admin'; }  ;?></td>
                                            <td><?php echo $val['state']; ?></td>
                                            <td><?php echo $val['division'] ;?></td>
                                            <td><?php echo $val['ward_no'].', '.$val['gram_panchayat'].', '.$val['block'].', '.$val['dist'] ;?></td>
                                            <td><?php echo $val['mobile_no'] ;?></td>
                                            <td ><?php echo $val['email']; ?></td>
                                            <td ><?php echo $val['username'] ;?></td>
                                            <td ><?php echo $val['password'] ;?></td>
                                            <td> <a href="<?= base_url('admin/memberslistongroupid?id='.$val['id']);?>" class="btn btn-success btn-sm">View Members</a> </td>
                                        </tr>
                                       <?php 
                                        }
                                            }
