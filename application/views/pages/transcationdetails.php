                                    ...
                                    <tbody>
                                        <?php $i=0;
                                         if(!empty($transdetails)){
                                            ...
                                            foreach($transdetails as $val){$i++;  ?>
                                        <tr>
                                            
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $val['account_no']; ?></td>
                                            <td> <?php if($val['trans_type']=='Credit'){ echo '<span class="text-success">'.$val['trans_type'].'</span>'; }else{ echo  '<span class="text-danger">'.$val['trans_type'].'</span>'; }   ?></td>
                                            <td><?php echo $val['trans_amount']; ?></td>
