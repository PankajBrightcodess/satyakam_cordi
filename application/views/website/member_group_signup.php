            ...
            <center class="tittle"><h2>NEW GROUP CREATE</h2><h4>SIGN UP(FORM)</h4></center>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-2">
                  ...
                  <input type="hidden" name="sponsor_id" value="<?php echo $_SESSION['member_id'];?>" placeholder="Sponsor Id No. :" readonly class="form-control" required>
                </div>
              <div class="col-md-6 mb-2">
                ...
                <div class="col-md-6 mb-2"> 
                 ...
                 <div class="col-md-6 mb-2"> 
                   ...
                   <input type="text" name="created_by" value="<?php echo $_SESSION['member_id'];?>"  placeholder="Sponsor Id No. :" readonly class="form-control" required>
                </div>
                 <div class="col-md-6 mb-2">
