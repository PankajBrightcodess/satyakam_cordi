                    ...
                    <div class="row">
                            <div class="col-md-12 col-lg-12">
                                ...
                                <table class="table data-table stripe hover nowrap table-bordered">
                                    ...
                                    <a class="pull-right btn btn-warning btn-large" style="margin-right:40px" href="<?php echo base_url('website/excel_memberlist'); ?>"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
