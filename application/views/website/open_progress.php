              ...
              <div class="col-md-12 mb-2">
                ...
                <div class="panel">
                  <div class="row">
                    ...
                    <div class="col-md-6 col-6 mb-3">
                      <label> Father/Husband Name & Address</label>
                      <input type="text" name="address" class="form-control" placeholder="Enter Father/Husband Name">
                    </div>
                     <div class="col-md-6 col-6 mb-3">
                      <label> D.O.B.</label>
                    ...
                    <div class="col-md-6 col-6 mb-3">
                      ...
                      <input type="text" name="post_name" class="form-control" placeholder="Enter Father/Husband Name">
                    </div>
                    <div class="col-md-6 col-6 mb-3">
                      <label> Fee</label>
                      <input type="number" name="post_name" class="form-control" placeholder="Enter Fee">
                    </div>
                    <div class="col-md-6 col-6 mb-3">
                     ...
                     <div class="col-md-6 col-6 mb-3">
                      <label>Banking ID No.</label>
                      <input type="date" name="banking_id_no" class="form-control">
                    </div>
                ...
                <div class="panel">
                 <div class="row">
                    ...
                    <div class="col-md-6 col-6 mb-3">
                      ...
                      <input type="text" name="name_of_post" class="form-control" placeholder="Enter Father/Husband Name">
                    </div>
                     <div class="col-md-6 col-6 mb-3">
                      <label>Security Fund</label>
                      <input type="text" name="security_fund" placeholder="Enter Security Fund" class="form-control">
                    </div>
                  
                    <div class="col-md-6 col-6 mb-3">
                      <label>Training Fee</label>
                      <input type="number" name="training_fee" class="form-control" placeholder="Enter Training Fee">
                    </div>
                    <div class="col-md-6 col-6 mb-3">
                      <label>Processing Fee</label>
                      <input type="text" name="processing_fee" placeholder="Enter Processing Fee" class="form-control">
                    </div>
                     <div class="col-md-6 col-6 mb-3">
                      <label>Other Fee.</label>
                      <input type="text" name="other_fee" placeholder="Enter Other Fee" class="form-control">
                    </div>
                     <div class="col-md-12 col-6 mb-3">
                      <label>Total Banking</label>
                      <input type="text" name="total_banking" placeholder=" Enter Total Banking" class="form-control">
                    </div>
                    <div class="col-md-12 col-12 mb-3">
                      <label>Banking ID No./Date</label>
                      <input type="text" name="banking_id" placeholder=" Enter Total Banking" class="form-control">
                    </div>
                    <div class="col-md-12 col-12 mb-3">
                      <label>Total Revenue</label>
                      <input type="text" name="total_revenue" placeholder="Enter Total Revenue" class="form-control">
                ...
                <div class="panel">
                 <div class="row">
                    ...
                    <div class="col-md-6 col-6 mb-3">
                      ...
                      <input type="text" name="group_address" class="form-control" placeholder="Enter Group Address">
                    </div>
                     <div class="col-md-6 col-6 mb-3">
                      <label>Meeting No.</label>
                      <select class="form-control" name="meeting_no">
                    ...
                    <div class="col-md-6 col-6 mb-3">
                      <label>Passbook Issued Fee</label>
                      <input type="number" name="passbook_issue_fee" class="form-control" placeholder="Enter Passbook Issued Fee">
                    </div>
                    <div class="col-md-6 col-6 mb-3">
                      <label>Weekly Saving Deposit</label>
                      <input type="text" name="weekly_saving_deposit" placeholder="Enter Weekly Saving Deposit" class="form-control">
                    </div>
                     <div class="col-md-6 col-6 mb-3">
                      <label>EMI Deposit</label>
                      <input type="text" name="emi_deposit" placeholder="Enter EMI Deposit" class="form-control">
                    </div>
                     <div class="col-md-6 col-6 mb-3">
                      <label>Bounsing Fee</label>
                      <input type="text" name="bouncing_fee" placeholder=" Enter Bouncing Fee" class="form-control">
                    </div>
                    <div class="col-md-6 col-6 mb-3">
                      <label>Late Fine Fee</label>
                      <input type="text" name="late_fine_fee" placeholder=" Enter Late Fine Fee" class="form-control">
                    </div>
                    <div class="col-md-6 col-6 mb-3">
                      <label>Banking Id No./date/Time</label>
                      <input type="text" name="total_revenue" placeholder="Enter Banking Id No./date/Time" class="form-control">
                    </div>
                    <div class="col-md-12 col-12 mb-3">
                      <label>Total Revenue</label>
                      <input type="text" name="total_revenue" placeholder="Enter Total Revenue" class="form-control">
