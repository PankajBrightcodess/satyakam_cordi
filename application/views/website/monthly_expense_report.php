<section class="content">
      <div class="container">
    	<div class="row">
             <div class="col-md-12 mb-3">
                <div class="card">
                     <div class="card-header">
                        <h3 class="card-title text-center">Monthly Expense Report</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
            ...
            <?php 
                if(!empty($expense_month)){
                    ?>
            <div class="col-md-12 mb-3">
                <div class="card">
                   <div class="card-header">
                        <h3 class="card-title">Monthly Expense Report</h3>
                    </div> 
                    <div class="card-body">
                    <div class="row">
                            <div class="col-md-12 col-lg-12">
                                ...
                                <table class="table data-table stripe hover nowrap table-bordered">
                                    ...
                                    <a class="pull-right btn btn-warning btn-large" style="margin-right:40px" href="<?php echo base_url('website/createexcel_monthly_expensedetails'); ?>"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
                                    <tbody>
                                        <?php $i=0;
                                         if(!empty($expense_month)){
                                            foreach($expense_month as $val){$i++; $id=$val['id']; ?>
                                        <tr>
                                            <td ><?php echo $i ?></td>
