        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo base_url('website/addrecord_membership');?>"  method="POST" enctype="multipart/form-data" style="border:1px solid black;padding: 10px;margin-top: 20px;background: white;">
                        <div class="row">
                          <div class="col-md-8">
