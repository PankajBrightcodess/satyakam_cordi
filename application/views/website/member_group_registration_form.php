                    ...
                    <thead>
                      ...
                      <tr>
                        <th scope="col">Group Name  :&nbsp;&nbsp;<?php echo $group_records['group_name'];?></th>
                         <!-- <th scope="col" >Landmark/Pin Code  :&nbsp;&nbsp;</th> -->
                          <th scope="col" >Sponsor Id No.  :&nbsp;&nbsp;<?php echo $group_records['created_by'];?></th>
                          <th scope="col">Sponsor Name  :&nbsp;&nbsp;<?php echo $group_records['applicant_name'];?></th>
                      </tr>
                      <tr>
                         <th scope="col">Mobile No.  :&nbsp;&nbsp;<?php echo $group_records['cell_no'];?>
