                ...
                <tbody>
                  <tr>
                    <td><label class="ml-2">MEMBERSHIP CERTIFICATE</label> <a href="<?= base_url('website/get_member_certificate');?>" class="btn btn-sm btn-success mr-5" >DOWNLOAD</a></td>
                     <td>QUALIFICATION CERTIFICATE <a href="<?= base_url($uploadfiles['qualification_certificate']);?>" class="btn btn-sm btn-success ml-2" >DOWNLOAD</a></td>
                    
                  </tr>
                  <tr>  
                    <td>AADHAR(Front) <a href="<?= base_url($uploadfiles['aadhar_front']);?>" class="btn btn-sm btn-success ml-2">DOWNLOAD</a></td>
                    <td>AADHAR(back) <a href="<?= base_url($uploadfiles['aadhar_back']);?>" class="btn btn-sm btn-success ml-2">DOWNLOAD</a></td>
                  </tr>
                  <tr>  
                   <td>ELECTION ID CARD(Front)<a href="<?= base_url($uploadfiles['election_id_card']);?>" class="btn btn-sm btn-success ml-2" >DOWNLOAD</a></td>
                    <td>ELECTION ID CARD(Back)<a href="<?= base_url($uploadfiles['election_id_card_back']);?>" class="btn btn-sm btn-success ml-2">DOWNLOAD</a></td>
                  </tr>
                  <tr>
