<section class="officialservices">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-12">
            <form method="POST" action="<?= base_url('website/group_resource_insert')?>">
            <div class="row">
                 ...
                 <table class="table table-hover" style="text-align: center;">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" rowspan="4"><h5 class="tittle">GROUP RESOURCE DEMAND FORM</h5></th>
             ...
             <div class="col-md-12 mb-2">
              <table class="table">
                <tbody class="requipment">
                  ...
                  <input type="text" name="group_no" placeholder="ENTER GROUP NO." class="form-control mb-2"></td>
                  <td><label>Group Name</label>
                  <input type="text" name="group_name" placeholder="ENTER GROUP NAME" class="form-control mb-2"></td>
                  <td><label>Installation Date</label>
                  <input type="date" name="installation_date" placeholder="ENTER INSTALLATION DATE" class="form-control mb-2"></td>
                  </tr>
            </tbody>
            </table>
              ...
              <div class="col-md-12 mb-2">
                  <table class="table-responsive table">
                    <thead>
                      ...
                      <tr>
                        <th colspan="10"><button class="btn-sm btn-success btn add_group_resource">+</button></th>
                        
                      </tr>
                    </thead>
                    <tbody class="group_resource">
                      <tr>
                        ...
                        <td><input type="number" name="rate[]" id="rate" class="form-control"></td>
                        <td><input type="number" name="amount[]" id="amount" class="form-control"></td>
                        <td><input type="number" name="total_amount[]" id="amount" class="form-control"></td>
                       
                        <td><button type="button" class="btn btn-info btn-xs remove_group_resource" ><i class="fa fa-trash" aria-hidden="true"></i></button></td>
                      </tr>
                    </tbody>
                  </table>
                  <div class="mb-2">
              ...
              <div class="col-md-12 mb-5">
                ...
                <div class="col-md-1 col-1 col-lg-1 text-success"><label><strong>NOTE :-</strong></label></div>
                <div class="col-md-11 col-11 col-lg-11"><label><strong>RESOURCE OR EQUIPMENT RELATED TO THE GROUP WILL BE PROVIDED TO THE GROUP WHOSE ESTABLISHMENT IS AT LEAST 3 MONTHS OLD.</strong></label></div>
