...
<!-- <button type="button" class="btn btn-primary hidden" id="myCheck" data-toggle="modal" data-target="#newyear">
  Launch demo modal
</button>
 <div class="modal-dialog modal-xl" id="newyear" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     
      <div class="modal-body">
        <iframe src="https://giphy.com/embed/bnVMLaBcfZEMatI31d" width="460" height="270" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p></p>
      </div>
