                        ...
                        <div class="row">
                         ...
                         <!--  <div class="col-md-3 col-12 mb-3">
                          ...
                          <!-- <div class="col-md-12 mb-3">
                           ...
                           <div class="col-md-6 mb-3">
                            <input type="text" name="aadhar_no" placeholder="Aadhar No." class="form-control" required>
                          </div>
                          <div class="col-md-6 mb-3">
                           ...
                           <div class="col-md-4 mb-3">
                            <input type="text" name="security_rs_amount" placeholder="RS (AMOUNT)" class="form-control" required>
                          </div>
                          <div class="col-md-4 mb-3">
                           <input type="text" name="security_transaction_id" placeholder="Transaction ID" class="form-control" required>
                          </div>
                          <div class="col-md-4 mb-3">
                           ...
                           <div class="col-md-4 mb-3">
                            <input type="text" name="processing_rs_amount" placeholder="RS (AMOUNT)" class="form-control" required>
                          </div>
                          <div class="col-md-4 mb-3">
                           <input type="text" name="processing_rs_transaction" placeholder="Transaction ID" class="form-control" required>
                          </div>
                          <div class="col-md-4 mb-3">
                           <input type="date" name="processing_rs_date" placeholder="Date" class="form-control" required>
                          </div>
                           ...
                           <div class="col-md-4 mb-3">
                              <input type="text" name="training_rs" placeholder="RS (AMOUNT)" class="form-control" required>
                          </div>
                          <div class="col-md-4 mb-3">
                           <input type="text" name="training_transaction" placeholder="Transaction ID" class="form-control" required>
                          </div>
                          <div class="col-md-4 mb-3">
